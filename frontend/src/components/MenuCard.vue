  ...
  >
    ...
    <div class="px-5 pb-5">
      <a href="#">
        ...
        <h4
          class="text-l font-medium tracking-tight text-gray-700 dark:text-white"
        >
      ...
      <div class="flex items-center mt-2.5 mb-5">
        ...
        <span
          class="bg-orange-100 text-orange-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-800 ms-3"
          >5.0</span
        >
      </div>
...
defineProps({ product: Object, buttonText: String });
