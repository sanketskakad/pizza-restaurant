        ...
        <div class="mb-4">
          <Accordion header="Sizes">
            <div class="flex flex-col mt-4 mb-4 bg-orange-50">
              <div class="flex mb-2" v-for="size in menu.formData.sizes">
                ...
                <div class="basis-2/12 flex ml-2 justify-center items-center">
                  <button
                    class="focus:outline-none mt-6 text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
                  >
                    <svg
                      fill="#fff"
                      height="20px"
        ...
        <div class="mb-4">
          <Accordion header="Extra Ingredients"
            ><div class="flex flex-col mb-4 mt-4 bg-orange-50">
              <div
                class="flex mb-2"
                v-for="size in menu.formData.extraIngredients"
              >
                <div class="basis-5/12 ml-2">
                  <label
                    class="block text-gray-700 text-sm font-bold mb-2"
